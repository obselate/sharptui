...
namespace Facebook.Yoga
{
    ...
    {
        internal static FlexLineState CalculateFlexLine(
            Node node,
            ...
            int lineCount)
        {
            ...
            for (; index < layoutChildren.Count; index++)
            {
                var child = layoutChildren[index];
